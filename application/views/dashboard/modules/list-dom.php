<div class="row">
    ...
    foreach (force_array($modules) as $_module) {
        ...
        <div class="col-lg-4 col-md-4 col-sm-5 col-xs-6">
            ...
            ?>" <?php if (! Modules::is_active($module_namespace)):?> style="background:#F3F3F3;"
                <?php endif;
            ?>>
            ...
            ?>      </small> 
                    ...
                    if( $hasMigration ):?>
                    <a href="<?php echo site_url([ 'dashboard', 'modules', 'migrate', $module_namespace, $last_version ]);?>" class="migrate-module pull-right btn btn-sm btn-primary"><i class="fa fa-database"></i></a>
                    <?php endif;?>
                </div>
